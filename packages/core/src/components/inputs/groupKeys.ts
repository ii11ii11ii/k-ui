...
export const CheckboxGroupKey: InjectionKey<CheckboxGroupCtx> = Symbol('kui-checkbox-group')
export interface RadioGroupCtx { value: any; pick: (v: any) => void; disabled: boolean; name: string }
export const RadioGroupKey: InjectionKey<RadioGroupCtx> = Symbol('kui-radio-group')
